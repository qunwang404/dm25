...
Connection string URL used to connect to the database for the metadata service.
...
* 2. For PostgreSQL, the default value is `jdbc:postgresql://<DBHost>:<DBport>/<DB_NAME>?escapeSyntaxCallMode=callIfNoReturn`.
