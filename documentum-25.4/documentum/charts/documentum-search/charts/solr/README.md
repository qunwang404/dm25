...
The chart installs the Solr docker image from: https://artifactory.otxlab.net/artifactory/bpdockerhub/dctm-search-solr/
...
```txt
helm repo add bphelm https://artifactory.otxlab.net/artifactory/BPhelm/
helm install --name solr bphelm/dctm-search-solr
```
