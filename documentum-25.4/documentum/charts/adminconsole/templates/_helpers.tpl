...
{{- define "configMap.labels" }}
  labels:
    app.kubernetes.io/name: {{ include "adminconsole.name" . }}
...
*/}}
{{- define "adminconsole.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}


{{/*
Finalise on the admin console service port for ssl or non-ssl deployment.
*/}}
{{- define "adminconsole.servicePort" -}}
