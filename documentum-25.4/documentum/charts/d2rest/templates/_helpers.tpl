...
{{- define "d2rest.connectionremoteurl" -}}
{{- $name := print (.Values.settings.connectionRemoteUrl | default (include "documentum.publicIngress" .)) "/" (.Values.env.webappName | default .Values.global.d2restWebappName)  -}}
{{- printf $name -}}
{{- end -}}

{{- define "d2rest.servicePort" -}}
